...
#CREATE PLOT THORNTHWAITE
    ...
    Plots.savefig("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*modelpath*"/"*modelpath*"_"*string(startyear_hist)*"_"*string(startyear_proj)*"Budyko_projections_tw.png")
...
#     xaxis!("Epot/P")
#     yaxis!("Eact/P")
#     Plots.savefig("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*modelpath*"/"*modelpath*"_"*string(startyear_hist)*"_"*string(startyear_proj)*"Budyko_projections_hg.png")
    ...
    # end
    #
    # Plots.savefig("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*modelpath*"/"*modelpath*"_"*string(startyear_hist)*"_"*string(startyear_proj)*"Budyko_projections_twhg.png")
    ...
    #     xlims!((0,2))
    #     ylims!((0.2,1))
    #     Plots.savefig("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/"*catchment*"/"*rcp*"/"*catchment*"_"*modelpath*string(startyear_hist)*"_"*string(startyear_proj)*"Budyko_allcatchments_hgtw.png")
    #
    # end
    ...
    CSV.write("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*modelpath*"/"*modelpath*"_"*string(startyear_hist)*"_"*string(startyear_proj)*"_projected_budyko_tw.csv", Catchment_data_pro_tw)
    CSV.write("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*modelpath*"/"*modelpath*"_"*string(startyear_hist)*"_"*string(startyear_proj)*"_projected_buydko_hg.csv", Catchment_data_pro_hg)
    CSV.write("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*modelpath*"/"*modelpath*"_"*string(startyear_hist)*"_"*string(startyear_proj)*"_projected_budyko_hgtw.csv", Catchment_data_pro_all)
    CSV.write("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*modelpath*"/"*modelpath*"_"*string(startyear_hist)*"_"*string(startyear_proj)*"_projected_RC_hgtw.csv", Runoff_coefficients)
...
function Budyko_plot_catchment(startyear_hist, startyear_proj)
        local_path = "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/"
        Color = palette(:tab10)
        Markers = [:rect, :circle, :dtriangle, :cross]
        rcps=["rcp45", "rcp85"]
        All_Catchments = ["Defreggental", "Gailtal", "Feistritz", "Palten", "Pitztal", "Silbertal"]
                ...
                Budyko_Eact_P = ( Epot_Prec .* tanh.(1 ./Epot_Prec) .* (ones(length(Epot_Prec)) - exp.(-Epot_Prec))).^0.5
                        ...
                        for (j,rcm) in enumerate(rcms)
                                ...
                                for (k,catchment) in enumerate(All_Catchments)
                                    ...
                                    xlims!((0,2))
                                    ylims!((0.2,1))
                                    Plots.savefig("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/"*catchment*"/"*rcp*"/"*catchment*"_"*rcm*string(startyear_hist)*"_"*string(startyear_proj)*"_Budyko_plot_projected_2methods.png")
...
"""
This Function creates a plot showing respective movement of each catchment from observed, RCP4.5 and RCP8.5
$SIGNATURES
"""
...
function Budyko_plot_catchment_total(startyear_hist, startyear_proj)
        ...
        for m in 1:1:14
            ...
            Pastdata = CSV.read(local_path*"Past/All_catchments_omega_all_loss.csv", DataFrame, header= true, decimal='.', delim = ',')
                ...
                Plots.savefig("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Results/Movements/"*string(m)*"_"*(rcms[m])[1:4]*"_"*string(startyear_hist)*"_"*string(startyear_proj)*"_Budyko_movements_OP_MF.png")
