...
function run_srdef_GEV_defreggental_p(path_to_projection, path_to_best_parameter, startyear, endyear, spinup, rcp, rcm)
        ...
        path_to_folder = "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Defreggental/"*rcp*"/"*rcm*"/"
        ...
        for (e, ep_method) in enumerate(EP)
                ...
                Budyko_output_future = CSV.read( "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day_1981_2071_projected_RC_hgtw.csv", DataFrame, decimal = '.', delim = ',')
                Historic_data= CSV.read("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Past/All_catchments_observed_meandata.csv", DataFrame, decimal = '.', delim = ',' )
                Budyko_output_past= CSV.read("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Past/All_catchments_omega_all.csv", DataFrame, decimal = '.', delim = ',' )
                ...
                for  n = 1:1:1#size(parameters_best_calibrations)[1]
                        ...
                        #         #xt2, xt20 = GEVresult_Palten("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Palten/", "Palten", rcp, rcm)
                        ...
                        #CSV.write("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/GEV/Defreggental_GEV_T.csv", dfgev)
                ...
                #CSV.write("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*string(startyear)*"_GEV_T.csv", Output)
...
function run_srdef_GEV_defreggental_obs_p(path_to_best_parameter, startyear, endyear, spinup, rcp, rcm)
        ...
        for n = 1#:1:size(parameters_best_calibrations)[1]
                ...
                #         yaxis!("mm")
                #         #display(Peplot)
                #         Plots.savefig( "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_Pe_melt_timeseries_analysis"*string(startyear)*"_"*string(endyear)*".png" )
                #
                #
                ...
                #         yaxis!("mm")
                #         #display(Pepplot)
                #         Plots.savefig( "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_Pep_timeseries_analysis_"*string(startyear)*"_"*string(endyear)*".png" )
                # end
                # All_GWstorage = hcat(All_GWstorage, GWstorage[index_spinup: index_lastdate])
                # All_Snowstorage = hcat(All_Snowstorage, Snowstorage[index_spinup: index_lastdate])
                # parameter ranges
...
#                         end
#                         df = DataFrame(Srmax_forest = Srmax_forest, Srmax_grass = Srmax_grass)
#                         #xt2, xt20 = GEV_defreggental("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Defreggental/")
#                         violin!(df.Srmax_forest, color="Darkgreen", legend=false)
#                         #scatter!(xt20)
#                         violin!(df.Srmax_grass, color="Lightgreen", legend=false)
#                         #scatter!(xt2)
...
function run_srmax_rcps_defreggental()
        path_to_best_parameter= "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Defreggental_parameterfitless_dates_snow_redistr_best_combined_300_validation_10years.csv"
        local_path = "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/"
        rcps=["rcp45", "rcp85"]
...
function GEVresult_defreggental(path_to_best_parameter, catchment_name, rcp, rcm)
        ...
        Plots.savefig("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*catchment_name*"/"*rcp*"/"*rcm*"/Forest_parameter_comparison.png")
        ...
        yaxis!("Sr,max [mm]", font(8))
        Plots.savefig("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*catchment_name*"/"*rcp*"/"*rcm*"/Grass_parameter_comparison.png")
...
#run_srdef_GEV_defreggental("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 2071,2100, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
# run_srdef_GEV_defreggental("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1978,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_defreggental("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1981,2013, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_defreggental_obs("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1981,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#
# GEVresult_defreggental("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", "Defreggental", "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#

time85, srdef85 = run_srdef_GEV_defreggental_p("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Test/Defreggental_Parameterfit_less_dates_snow_redistr_test1.csv", 2071,2100, 3,  "rcp85", "CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
time45, srdef45 = run_srdef_GEV_defreggental_p("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Test/Defreggental_Parameterfit_less_dates_snow_redistr_test1.csv", 2071,2100, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
timemp45,srdefmp45= run_srdef_GEV_defreggental_p("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Test/Defreggental_Parameterfit_less_dates_snow_redistr_test1.csv", 1978,2010, 3,"rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_defreggental("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Defreggental_Parameterfit_less_dates_snow_redistr_1_test.csv", 1981,2013,"future2100", 3, "no", "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
timeop, srdefop = run_srdef_GEV_defreggental_obs_p("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Test/Defreggental_Parameterfit_less_dates_snow_redistr_test1.csv", 1981,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#
# println(size(time85), size(srdefop))
srdefplot=Plots.plot()
# plot!(time85, srdef85, color=:blue)
# plot!(time45, srdef45, color=:red)
plot!(timemp45, srdefmp45, color=:black)
plot!(timeop, srdefop, color=:grey)
display(srdefplot)


# GEVresult_defreggental("/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Defreggental_Parameterfit_less_dates_snow_redistr_1_0.csv", "Defreggental", "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#/Users/rubenvanstreun/Documents/MacBookPro/1. Master/1.4 Thesis/02 Execution/01 Model Sarah
