...
function run_srmax_rcps_gailtal()
        path_to_best_parameter= "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Gailtal/Best/Parameterfit_less_dates_snow_redistr_1M_best_300.csv"
        ...
        #rcms = readdir(local_path*rcp)
                ...
                for (j,rcm) in enumerate(rcms)
                        ...
                        run_srdef_GEV_gailtal(path_to_projection, path_to_best_parameter, 2071,2100, 3, rcp, rcm)
                        #run_srdef_GEV_gailtal(path_to_projection, path_to_best_parameter, 1978,2010, 3, "no", rcp, rcm)
                        run_srdef_GEV_gailtal(path_to_projection, path_to_best_parameter, 1981,2013, 3, rcp, rcm)
                        run_srdef_GEV_gailtal_obs(path_to_best_parameter, 1981,2013, 3, rcp, rcm)
...
#run_srmax_rcps_gailtal()
#GEVresult_rcps_gailtal("Gailtal")
