...
function run_srdef_GEV_defreggental_p(path_to_projection, path_to_best_parameter, startyear, endyear, spinup, rcp, rcm)
        srdef_cumplot = []
        Timeseriesplot=[]

        local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        path_to_folder = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Defreggental/"*rcp*"/"*rcm*"/"
        ...
        for (e, ep_method) in enumerate(EP)
                ...
                Budyko_output_future = CSV.read( "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day_1981_2071_projected_RC_hgtw.csv", DataFrame, decimal = '.', delim = ',')
                Historic_data= CSV.read("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Past/All_catchments_observed_meandata.csv", DataFrame, decimal = '.', delim = ',' )
                Budyko_output_past= CSV.read("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Past/All_catchments_omega_all.csv", DataFrame, decimal = '.', delim = ',' )
                ...
                println(length(Total_Precipitation_series))
                ...
                for  n = 1:1:1#size(parameters_best_calibrations)[1]
                        ...
                        #         #xt2, xt20 = GEVresult_Palten("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Palten/", "Palten", rcp, rcm)
                        ...
                        #CSV.write("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/GEV/Defreggental_GEV_T.csv", dfgev)
                ...
                #CSV.write("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Defreggental/"*ep_method*string(startyear)*"_GEV_T.csv", Output)

        #finding frequency factor k
        push!(Timeseriesplot, Timeseries[1,index_spinup:end])
        push!(srdef_cumplot, srdef_cum)
        println(size(srdef_cumplot[1]))
        ...
        return Timeseriesplot[1],  srdef_cumplot[1]#,#srdef_, yearseries#Pe_mean, Ei_mean
end
...
function run_srdef_GEV_defreggental_obs_p(path_to_best_parameter, startyear, endyear, spinup, rcp, rcm)
        srdef_cumplot = []
        Timeseriesplot=[]
        local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        # ------------ CATCHMENT SPECIFIC INPUTS----------------
        ...
        Plots.plot(title="Defreggental", titlefontsize=12)
        for n = 1#:1:size(parameters_best_calibrations)[1]
                Current_Inputs_All_Zones = deepcopy(Inputs_All_Zones)
                Current_Storages_All_Zones = deepcopy(Storages_All_Zones)
                Current_GWStorage = deepcopy(GWStorage)
                ...
                #         yaxis!("mm")
                #         #display(Peplot)
                #         Plots.savefig( "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_Pe_melt_timeseries_analysis"*string(startyear)*"_"*string(endyear)*".png" )
                #
                #
                ...
                #         yaxis!("mm")
                #         #display(Pepplot)
                #         Plots.savefig( "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Defreggental/"*ep_method*"_Pep_timeseries_analysis_"*string(startyear)*"_"*string(endyear)*".png" )
                # end
                # All_GWstorage = hcat(All_GWstorage, GWstorage[index_spinup: index_lastdate])
                # All_Snowstorage = hcat(All_Snowstorage, Snowstorage[index_spinup: index_lastdate])
                # parameter ranges
                ...
                push!(Timeseriesplot, Timeseries[index_spinup:end])
                push!(srdef_cumplot, srdef_cum)
        ...
        return Timeseriesplot[1], srdef_cumplot[1]
end

# function run_srdef_GEV_defreggental_withplot( path_to_projection, path_to_best_parameter, startyear, endyear, period, spinup, ploton, rcp, rcm)
#         local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
#         path_to_folder = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Defreggental/"*rcp*"/"*rcm*"/"
#         # ------------ CATCHMENT SPECIFIC INPUTS----------------
#         ID_Prec_Zones = [17700, 114926]
...
# end
#
# function run_srdef_GEV_defreggental_obs_withplot(path_to_best_parameter, startyear, endyear, period, spinup, ploton, rcp, rcm)
#         local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
#         # ------------ CATCHMENT SPECIFIC INPUTS----------------
#         ID_Prec_Zones = [17700, 114926]
#         # size of the area of precipitation zones
...
#                         endplot = 5 * 365
#
#                         srdeftimeser=Plots.plot(title="Defreggental", titlefontsize=12)
...
#
#                         srdeftime=Plots.plot(title="Defreggental", titlefontsize=12)
#                         plot!( Timeseries[startplot:endplot], srdef_timeseries[startplot:endplot], label = "Sr_def_series", )
#                         yaxis!("mm")
#                         xaxis!("Date")
...
#                         display(srdeftime)
#
#                         srdefcum = Plots.plot(title="Defreggental", titlefontsize=12)
...
#                         display(srdefcum)
#
#                         cumzoom = Plots.plot(title="Defreggental", titlefontsize=12)
...
#                         dispaly(cumzoom)
#
#                         alltimeser = Plots.plot(title="Defreggental", titlefontsize=12)
#                         plot!( Timeseries[startplot:endplot], Er_timeseries[startplot+1:endplot+1], label = "Er", )
#                         plot!( Timeseries[startplot:endplot], All_Pe[:, n+1][startplot+1:endplot+1], label = "Pe", )
#                         plot!( Timeseries[startplot:endplot], srdef_timeseries[startplot:endplot], label = "Sr_def_series", )
#                         #plot!( Timeseries[startplot:endplot], srdef_continuous[startplot+1:endplot+1], label = "Sr_def_cum", )
...
#                         end
#                         df = DataFrame(Srmax_forest = Srmax_forest, Srmax_grass = Srmax_grass)
#                         #xt2, xt20 = GEV_defreggental("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Defreggental/")
#                         violin!(df.Srmax_forest, color="Darkgreen", legend=false)
#                         #scatter!(xt20)
#                         violin!(df.Srmax_grass, color="Lightgreen", legend=false)
#                         #scatter!(xt2)
...
function run_srmax_rcps_defreggental()
        path_to_best_parameter= "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Defreggental_parameterfitless_dates_snow_redistr_best_combined_300_validation_10years.csv"
...
function GEVresult_defreggental(path_to_best_parameter, catchment_name, rcp, rcm)
        ...
        Plots.savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*catchment_name*"/"*rcp*"/"*rcm*"/Forest_parameter_comparison.png")
        ...
        yaxis!("Sr,max [mm]", font(8))
        Plots.savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*catchment_name*"/"*rcp*"/"*rcm*"/Grass_parameter_comparison.png")
...
#run_srdef_GEV_defreggental("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 2071,2100, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
# run_srdef_GEV_defreggental("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1978,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_defreggental("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1981,2013, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_defreggental_obs("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1981,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#
# GEVresult_defreggental("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", "Defreggental", "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#

time85, srdef85 = run_srdef_GEV_defreggental_p("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Test/Defreggental_Parameterfit_less_dates_snow_redistr_test1.csv", 2071,2100, 3,  "rcp85", "CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
time45, srdef45 = run_srdef_GEV_defreggental_p("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Test/Defreggental_Parameterfit_less_dates_snow_redistr_test1.csv", 2071,2100, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
timemp45,srdefmp45= run_srdef_GEV_defreggental_p("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Test/Defreggental_Parameterfit_less_dates_snow_redistr_test1.csv", 1978,2010, 3,"rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_defreggental("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Defreggental/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Defreggental_Parameterfit_less_dates_snow_redistr_1_test.csv", 1981,2013,"future2100", 3, "no", "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
timeop, srdefop = run_srdef_GEV_defreggental_obs_p("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Test/Defreggental_Parameterfit_less_dates_snow_redistr_test1.csv", 1981,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#
# println(size(time85), size(srdefop))
function srdefplot(time45, time85, timemp45, timeop, srdef45, srdef85, srdefmp45, srdefop, years)
        length_days = years*365
        timeseries = 1:1:length_days

        deficits_plot=Plots.plot()
        # println(size(time85))
        # println(size(srdef85))
        plot!(timeseries, srdef85[1:length_days], color=:blue)
        plot!(timeseries, srdef45[1:length_days], color=:red)
        plot!(timeseries, srdefmp45[1:length_days], color=:black)
        plot!(timeseries, srdefop[1:length_days], color=:grey, grid=false)
        display(deficits_plot)

        return
end

# srdefplot(time45, time85, timemp45, timeop, srdef45, srdef85, srdefmp45, srdefop, 3)



# GEVresult_defreggental("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental/Defreggental_Parameterfit_less_dates_snow_redistr_1_0.csv", "Defreggental", "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah
