...
"""
This function calculates the yearly root zone storage deficits (srdef) for the Feistritztal.
...
"""
function run_srdef_GEV_feistritz( path_to_projection, path_to_best_parameter, startyear, endyear, spinup, rcp, rcm)
        local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        path_to_folder = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Feistritz/"*rcp*"/"*rcm*"/"
        ...
        if endyear <= Dates.year(Timeseries[end])
                if rcm[1:4]=="MOHC" && endyear == 2100
                        startyear = endyear - 27 - spinup
                else
        ...
        startyear_b = 0
        if startyear <= 2071 && startyear >= 2065
                startyear_b = 2071
        else
                startyear_b=startyear
        end
        indexstart_Proj = findfirst(x-> x == startyear, Dates.year.(Timeseries))[1]
        indexend_Proj = findlast(x-> x == endyear, Dates.year.(Timeseries))[1]
        ...
        for (e, ep_method) in enumerate(EP)
                ...
                Budyko_output_future = CSV.read( "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*rcm*"/"*rcm*"_1981_"*string(startyear_b)*"_projected_RC_hgtw.csv", DataFrame, decimal = '.', delim = ',')
                ...
                RC_hg = Budyko_output_future[3, 2]
                RC_tw = Budyko_output_future[3, 3]
                Q_hg =  Budyko_output_future[3, 5]
                Q_tw =  Budyko_output_future[3, 4]
                EI_obs = Budyko_output_past[3, 4]
                P_obs = Historic_data[3,2]
                ...
                for n = 1:1:size(parameters_best_calibrations)[1]
                        ...
                        #         #xt2, xt20 = GEVresult_Paltental("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Paltental/", "Palten", rcp, rcm)
                        ...
                        data = maxima #CSV.read(path_to_folder * ep_method* "_Feistritz_sdef_max_year_"*string(startyear)*"_"*string(endyear), DataFrame, header = true, decimal = '.', delim = ',')
                        ...
                        #         #CSV.write("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/GEV/Feistritz_GEV_T.csv", dfgev)
                        # end
                        # Ts = hcat(xt[1], xt[4])
                        # println(Ts)
                        # if n==1
                ...
                # writedlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Feistritz/"*rcp*"/"*rcm*"/Pe_timeseries_"*string(startyear)*"_"*string(endyear)*".csv", All_Pe, ',')
                # writedlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Feistritz/"*rcp*"/"*rcm*"/Er_timeseries_"*string(startyear)*"_"*string(endyear)*".csv", Er_timeseries, ',')
                ...
                #CSV.write("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/"*string(startyear)*"/Feistritz/"*ep_method*string(startyear)*"_GEV_T.csv", Output)
...
function run_srdef_GEV_feistritz_obs(path_to_best_parameter, startyear, endyear, spinup, rcp, rcm)
        local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        # ------------ CATCHMENT SPECIFIC INPUTS----------------
        ID_Prec_Zones = [109967]
        # size of the area of precipitation zones
        ...
        Potential_Evaporation_tw = getEpot_Daily_thornthwaite( Temperature_Mean_Elevation, Timeseries_Temp, Sunhours_Vienna)
        # Potential_Evaporation_hg, radiation = getEpot(Temperature_Mean_Elevation_Min, Temperature_Mean_Elevation, Temperature_Mean_Elevation_Max, 0.162,  Timeseries_Temp, Latitude)
        best_calibrations = readdlm(path_to_best_parameter, ',')
        parameters_best_calibrations = best_calibrations[:, 10:29]
        ns = 1:1:size(parameters_best_calibrations)[1]
        output_total = zeros(length(ns))
        ...
        Budyko_output_future = CSV.read( "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*rcm*"/"*rcm*"_1981_2071_projected_RC_hgtw.csv", DataFrame, decimal = '.', delim = ',')
        Historic_data= CSV.read("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Past/All_catchments_observed_meandata.csv", DataFrame, decimal = '.', delim = ',' )
        Budyko_output_past= CSV.read("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Past/All_catchments_omega_all.csv", DataFrame, decimal = '.', delim = ',' )
        ...
        for n = 1:1:size(parameters_best_calibrations)[1]
                ...
                #         yaxis!("mm")
                #         #display(Peplot)
                #         Plots.savefig( "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Feistritz/"*ep_method*"_Pe_melt_timeseries_analysis"*string(startyear)*"_"*string(endyear)*".png" )
                #
                #
                ...
                #         yaxis!("mm")
                #         #display(Pepplot)
                #         Plots.savefig( "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Past/Feistritz/"*ep_method*"_Pep_timeseries_analysis_"*string(startyear)*"_"*string(endyear)*".png" )
                # end
                # All_GWstorage = hcat(All_GWstorage, GWstorage[index_spinup: index_lastdate])
                # All_Snowstorage = hcat(All_Snowstorage, Snowstorage[index_spinup: index_lastdate])
                # parameter ranges
        ...
        #         xaxis!("T")
        #         yaxis!("mm")
        #         #Plots.savefig(path_to_folder*string(startyear)*ep_method*"_GEVstart_feistritz_Txt.png")
        #         display(gev2)
        # end
        # Ts = hcat(xt[1], xt[4])
        # println(Ts)
...
function run_srdef_GEV_feistritz_withplot( path_to_projection, path_to_best_parameter, startyear, endyear, period, spinup, ploton, rcp, rcm)
        local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        path_to_folder = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Feistritz/"*rcp*"/"*rcm*"/"
        # ------------ CATCHMENT SPECIFIC INPUTS----------------
        # ------------ CATCHMENT SPECIFIC INPUTS----------------
...
function run_srdef_GEV_feistritz_obs_withplot(path_to_best_parameter, startyear, endyear, period, spinup, ploton, rcp, rcm)
        local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        ID_Prec_Zones = [109967]
        # size of the area of precipitation zones
        Area_Zones = [115496400.]
        ...
        for n = 1:1:size(parameters_best_calibrations)[1]
                ...
                maxima =DataFrame(year=years_index, srdef_max=srdef_max_year)
                if ploton=="yes"
                        # writedlm( path_to_folder *ep_method* "_Feistritz_srdef_continuous", srdef_continuous, ',')
                        ...
                        df = DataFrame(Srmax_forest = Srmax_forest, Srmax_grass = Srmax_grass)
                        #xt2, xt20 = GEV_feistritz("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Feistritz/")
                        violin!(df.Srmax_forest, color="Darkgreen", legend=false)
                        #scatter!(xt20)
                        violin!(df.Srmax_grass, color="Lightgreen", legend=false)
                        #scatter!(xt2)
...
function run_srmax_rcps_feistritz()
        path_to_best_parameter= "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Feistritz/Best/Parameterfit_less_dates_snow_redistr_1M_best_300.csv"
        ...
        #rcms = readdir(local_path*rcp)
                ...
                for (j,rcm) in enumerate(rcms)
                        print(rcm)
                        path_to_projection = local_path*rcp*"/"*rcm*"/Pitten/"
                        run_srdef_GEV_feistritz(path_to_projection, path_to_best_parameter, 2071,2100, 3, rcp, rcm)
                        #run_srdef_GEV_feistritz(path_to_projection, path_to_best_parameter, 1978,2010, 3, rcp, rcm)
                        run_srdef_GEV_feistritz(path_to_projection, path_to_best_parameter, 1981,2013, 3,  rcp, rcm)
                        #run_srdef_GEV_feistritz_obs(path_to_best_parameter, 1981,2013, 3, rcp, rcm)
                end
        end
        return
end

function GEVresult_feistritz(path_to_best_parameter, catchment_name, rcp, rcm)
...
function GEVresult_rcps_feistritz(catchment_name)
        path_to_best_parameter= "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Feistritz/Best/Feistritz_parameterfitless_dates_snow_redistr_best_combined_300_validation_10years.csv"
        local_path = "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/"
        rcps=["rcp45", "rcp85"]
        for (i, rcp) in enumerate(rcps)
        #rcms = readdir(local_path*rcp)
...
# run_srdef_GEV_feistritz("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Pitten/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Feistritz/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 2071,2100, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
# run_srdef_GEV_feistritz("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Pitten/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Feistritz/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1978,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_feistritz("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Pitten/", "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Feistritz/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1981,2013, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_feistritz_obs("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Feistritz/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1983,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#
# GEVresult_feistritz("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Feistritz/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", "Feistritz", "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
#

#returns srdef values for grass and forest + HG & TW
#run_srmax_rcps_feistritz()
#GEVresult_rcps_feistritz("Feistritz")
path_to_best_parameter= "/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Feistritz/Best/Parameterfit_less_dates_snow_redistr_1M_best_300.csv"
