...
function run_srdef_GEV_paltental(path_to_projection, path_to_best_parameter, startyear, endyear,  spinup, rcp, rcm)
        ...
        path_to_folder = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Palten/"*rcp*"/"*rcm*"/"
...
function run_srmax_rcps_paltental()
        path_to_best_parameter= "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Palten/Best/Parameterfit_less_dates_snow_redistr_1M_best_300.csv"
        ...
        #rcms = readdir(local_path*rcp)
                ...
                for (j,rcm) in enumerate(rcms)
                        print(rcm)
                        path_to_projection = local_path*rcp*"/"*rcm*"/Palten/"
                        run_srdef_GEV_paltental(path_to_projection, path_to_best_parameter, 2071,2100, 3, rcp, rcm)
                        #run_srdef_GEV_Paltental(path_to_projection, path_to_best_parameter, 1978,2010, 3, rcp, rcm)
                        run_srdef_GEV_paltental(path_to_projection, path_to_best_parameter, 1981,2013, 3, rcp, rcm)
                        run_srdef_GEV_paltental_obs(path_to_best_parameter, 1981,2013, 3, rcp, rcm)
...
#run_srmax_rcps()
        ...
        #run_srdef_GEV_Paltental("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Paltental/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Paltental/Best/Paltental_parameterfitless_dates_snow_redistr_best_combined_300_validation_10years.csv", 2071,2100, 3, rcp, rcm)
        ...
        # run_srdef_GEV_Paltental("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/Paltental/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Paltental/Best/Paltental_parameterfitless_dates_snow_redistr_best_combined_300_validation_10years.csv", 1981,2013, 3, rcp, rcm)
...
#run_srmax_rcps_paltental()
#GEVresult_rcps_paltental("Palten")
