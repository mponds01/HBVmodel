...
"""
This function calculates the yearly root zone storage deficits (srdef) for the Silbertal
...
function run_srdef_GEV_silbertal( path_to_projection, path_to_best_parameter, startyear, endyear,  spinup, rcp, rcm)
        ...
        for (e, ep_method) in enumerate(EP)
                ...
                Budyko_output_future = CSV.read( "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Budyko/Projections/Combined/"*rcp*"/"*rcm*"/"*rcm*"_1981_"*string(startyear_b)*"_projected_RC_hgtw.csv", DataFrame, decimal = '.', delim = ',')
...
function run_srdef_GEV_silbertal_obs(path_to_best_parameter, startyear, endyear, spinup, rcp, rcm)
        local_path = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        # ------------ CATCHMENT SPECIFIC INPUTS----------------
        ID_Prec_Zones = [100206]
        # size of the area of precipitation zones
...
function run_srdef_GEV_silbertal_withplot( path_to_projection, path_to_best_parameter, startyear, endyear, period, spinup, ploton, rcp, rcm)
        local_path = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        path_to_folder = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Silbertal/"*rcp*"/"*rcm*"/"
        # ------------ CATCHMENT SPECIFIC INPUTS----------------
        ID_Prec_Zones = [100206]
...
function run_srdef_GEV_silbertal_obs_withplot(path_to_best_parameter, startyear, endyear, period, spinup, ploton, rcp, rcm)
        local_path = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"
        # ------------ CATCHMENT SPECIFIC INPUTS----------------
        ID_Prec_Zones = [100206]
        # size of the area of precipitation zones
...
function run_srmax_rcps_silbertal()
        path_to_best_parameter= "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal/Best/Parameterfit_less_dates_snow_redistr_1M_best_300.csv"
        ...
        #rcms = readdir(local_path*rcp)
                ...
                for (j,rcm) in enumerate(rcms)
                        print(rcm)
                        path_to_projection = local_path*rcp*"/"*rcm*"/IllSugadin/"
                        run_srdef_GEV_silbertal(path_to_projection, path_to_best_parameter, 2071,2100, 3, rcp, rcm)
                        #run_srdef_GEV_silbertal(path_to_projection, path_to_best_parameter, 1978,2010, 3, rcp, rcm)
                        run_srdef_GEV_silbertal(path_to_projection, path_to_best_parameter, 1981,2013, 3, rcp, rcm)
                        run_srdef_GEV_silbertal_obs(path_to_best_parameter, 1981,2013, 3, rcp, rcm)
...
function GEVresult_silbertal(path_to_best_parameter, catchment_name, rcp, rcm)
        ...
        # end
        # #scatter!(xt2)
        xticks!([1:4;], ["Forest C", "Forest OP", "Forest MP", "Forest MF"])#, "Forest MP", "Forest MF"])
...
# run_srdef_GEV_silbertal("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/IllSugadin/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 2071,2100, 3,  "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
# run_srdef_GEV_silbertal("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/IllSugadin/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1978,2010, 3, "rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_silbertal("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/rcp45/CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day/IllSugadin/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1981,2013, 3, rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day" )
# run_srdef_GEV_silbertal_obs("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal/Best/Parameterfit_less_dates_snow_redistr_best_100.csv", 1981,2010, 3,"rcp45", "CNRM-CERFACS-CNRM-CM5_rcp45_r1i1p1_CLMcom-CCLM4-8-17_v1_day")
...
# run_srmax_rcps_silbertal()

#GEVresult_rcps_silbertal("Silbertal")
