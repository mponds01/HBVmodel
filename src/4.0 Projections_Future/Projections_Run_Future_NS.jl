...
function run_projections_gailtal(path_to_projection, path_to_best_parameter, startyear, endyear, spinup, period, sns, rcp, rcm, cm)
        ...
        if length(parameters_best_calibrations)>=3000
        ...
        for n in 1 : 1:size(parameters_best_calibrations)[1]
                if count!= 100
                        ...
                        counter+=1
                        count = 0
                        println("nr of samples run,", counter*100)
                end
                ...
                if n in [750,1500,2250,size(parameters_best_calibrations)[1]]
                        path_result = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/"*period*"/"*sns*"/"*cm*"/"*rcp*"/"*rcm*"/"
                        ...
                        writedlm(path_result*sns*"_model_results_discharge_"*period*"runs-"*string(n)*".csv", All_Discharge, ',')
                        writedlm(path_result*sns*"_model_results_snow_melt_"*period*"runs-"*string(n)*".csv", All_Snowmelt, ',')
                        writedlm(path_result*sns*"_model_results_snow_cover_"*period*"runs-"*string(n)*".csv", All_Snow_Cover, ',')
                        println("printed", n)
                        All_Discharge = zeros(length(Timeseries_Obj))
                        All_Snowstorage = zeros(length(Timeseries_Obj))
                        All_Snowmelt = zeros(length(Timeseries_Obj))
...
function run_all_projections()
        catchments = ["Defreggental","Feistritz", "Gailtal", "Palten","Pitztal", "Silbertal"] #Defreggental
        for (c,cm) in enumerate(catchments)
                ...
                for (r,rcp) in enumerate(rcps)
                        ...
                        for (j,rcm) in enumerate(rcms)
                                path = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/"*rcp*"/"*rcm*"/"
                                cal_S = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/"*cm*"/Best/Parameterfit_less_dates_snow_redistr_1M_best_300.csv"
                                cal_NS_MF = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations_Srdef/"*cm*"/Samples/"*rcp*"/NS_Parameterset_MF_"*rcp*"_"*rcm*".csv"
                                cal_NS_OP = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations_Srdef/"*cm*"/Samples/"*rcp*"/NS_Parameterset_OP_"*rcp*"_"*rcm*".csv"
                                if cm == "Feistritz"
                                        println(cm, rcp, rcm)
                                ...
                                elseif cm == "Palten"
                                        ...
                                        Discharge_future_NS = run_projections_palten(path*"/Palten/", cal_NS_MF, 2071,2100,10, "Future", "NS", rcp, rcm, cm)
                                elseif cm == "Pitztal"
                                        println(cm, rcp, rcm)
...
#         println(i)
#         # @time begin
#         # Discharge_present = run_projections_pitztal(path*name*"/Pitztal/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Pitztal_loss_less_dates/Pitztal_Parameterfit_All_runs_best_300.csv", 1981, 2010, "past_2010",3, "45")
#         # end
...
#         # Discharge_present = run_projections_paltental(path*name*"/Palten/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Palten_less_dates/Palten_Parameterfit_All_less_dates_unique_best_300.csv", 1981, 2010, "past_2010",3)
#         # Discharge_present = run_projections_paltental(path*name*"/Palten/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Palten_less_dates/Palten_Parameterfit_All_less_dates_unique_best_300.csv", 2071, 2100, "future_2100", 10)
...
#         @time begin
#         println("current scenario", name)
#         # Discharge_present = run_projections_silbertal(path*name*"/IllSugadin/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal_less_dates/Silbertal_Parameterfit_All_less_dates_best_300.csv", 1981, 2010, "past_2010",3)
#         # Discharge_present = run_projections_silbertal(path*name*"/IllSugadin/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal_less_dates/Silbertal_Parameterfit_All_less_dates_best_300.csv", 2071, 2100, "future_2100", 10)
#         # Discharge_present = run_projections_paltental(path*name*"/Palten/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Palten_less_dates/Palten_Parameterfit_All_less_dates_unique_best_300.csv", 1981, 2010, "past_2010",3)
#         # Discharge_present = run_projections_paltental(path*name*"/Palten/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Palten_less_dates/Palten_Parameterfit_All_less_dates_unique_best_300.csv", 2071, 2100, "future_2100", 10)
#         #Discharge_present = run_projections_gailtal(path*name*"/Gailtal/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Gailtal_less_dates/Gailtal_Parameterfit_All_less_dates_best_proj.csv", 1981, 2010, "past_2010",3)
#         #Discharge_present = run_projections_gailtal(path*name*"/Gailtal/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Gailtal_less_dates/Gailtal_Parameterfit_All_less_dates_best_proj.csv", 2071, 2100, "future_2100", 10)
#         Discharge_present = run_projections_defreggental(path*name*"/Defreggental/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental_less_dates/Defreggental_Parameterfit_All_runs_less_dates_best_proj.csv", 1981, 2010, "past_2010",3)
#         # Discharge_present = run_projections_defreggental(path*name*"/Defreggental/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental_less_dates/Defreggental_Parameterfit_All_runs_less_dates_best_proj.csv", 2071, 2100, "future_2100", 10)
#         #Discharge_present = run_projections_pitztal(path*name*"/Pitztal/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Pitztal_loss_less_dates/Pitztal_Parameterfit_All_runs_best_300.csv", 1981, 2010, "past_2010",3, "85")
#         #Discharge_present = run_projections_pitztal(path*name*"/Pitztal/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Pitztal_loss_less_dates/Pitztal_Parameterfit_All_runs_best_300.csv", 2071, 2100, "future_2100", 10, "85")
#         end
# end
...
#for (i, name) in enumerate(Name_Projections[11:14])
         ...
         #Discharge_present = run_projections_defreggental(path*name*"/Defreggental/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Defreggental_Snow_Redistribution/Defreggental_Parameterfit_All_runs_snow_redistr_best_300.csv", 2071, 2100, "future_2010",10)
         #Discharge_present = run_projections_pitztal(path*name*"/Pitztal/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Pitztal_Snow_Redistribution/Pitztal_Parameterfit_All_runs_snow_redistr_best_300.csv", 1981, 2010, "past_2010",3, "45")
         #Discharge_present = run_projections_pitztal(path*name*"/Pitztal/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Pitztal_Snow_Redistribution/Pitztal_Parameterfit_All_runs_snow_redistr_best_300.csv", 2071, 2100, "future_2100",10, "45")
# #
# #
# #         Discharge_future = run_projections_silbertal(path*name*"/IllSugadin/", "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal_less_dates/Silbertal_Parameterfit_All_less_dates_best_300.csv", 2071, 2100, "future_2100", 10)
#end
# #
# end
# path = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/new_station_data_rcp85/rcp85/"
