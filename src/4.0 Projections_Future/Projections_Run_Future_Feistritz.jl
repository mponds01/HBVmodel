...
function run_projections_feistritz(path_to_projection, path_to_best_parameter, startyear, endyear, spinup, period, sns, rcp, rcm)
        ...
        path_result = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/"*period*"/"*sns*"/Feistritz/"*rcp*"/"*rcm*"/"
        ...
        writedlm(path_result*sns*"model_results_discharge_"*period*".csv", All_Discharge, ',')
        writedlm(path_resultn*sns*"model_results_snow_storage_"*period*".csv", All_Snowstorage, ',')
        writedlm(path_result*sns*"model_results_snow_melt_"*period*".csv", All_Snowmelt, ',')
