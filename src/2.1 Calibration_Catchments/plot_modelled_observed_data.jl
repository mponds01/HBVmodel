...
#All_Discharges, All_GWstorage, ALl_Snowstorage, All_Snow_Elevations, All_Soilstorage, All_Snow_Cover_Modeled, All_Snow_Cover_Observed, Observed_Discharge, Timeseries, All_Faststorage, Total_Precipitation, Temperature_Mean_Elevation, Potential_Evaporation  = run_bestparameters_pitztal("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Pitztal/Best/Parameterfit_less_dates_snow_redistr_1M_best_300.csv", 1, 1983, 2015,1)
#Catchment_Name ="Pitztal"

# Catchment_Name = "Silbertal"
# Area_Zones = [100139168.]
# Area_Catchment_Silbertal = sum(Area_Zones)
# All_Discharges, All_GWstorage, All_Snowstorage, All_Snow_Elevations, All_Soilstorage, All_Snow_Cover_Modeled, All_Snow_Cover_Observed, Observed_Discharge, Timeseries, All_Faststorage, Total_Precipitation, Temperature_Mean_Elevation = run_bestparameters_silbertal("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations/Silbertal/Best/Parameterfit_less_dates_snow_redistr_1M_best_300.csv", 1, 1983, 2015)
...
function plot_hydrographs(All_Discharges, Total_Precipitation, Temperature_Mean_Elevation, Timeseries, Catchment_Name, Nr_Years, Area_Catchment, nr_runs)
        for i in 1:Nr_Years
                ...
                if current_year == 1990
                        ...
                        Plots.savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Discharges/Discharge_All_"*string(current_year)*"_with_Prec.png")
                        #savefig("Discharge_All_"*string(current_year)*"_with_Prec_other_Temp_font.png")
                        #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Discharges/Discharge_All_"*string(current_year)*"_with_Prec_other_Temp_font.png")
                end
        end
end
...
function plot_hydrographs_final_report(All_Discharges, Total_Precipitation, Temperature_Mean_Elevation, Timeseries, Catchment_Name, Nr_Years, Area_Catchment, nr_runs)
        ...
        for i in [1,21]
                ...
                ylabel!("Discharge [mm/d]")
                title!(string(Catchment_Name), titlefont=font(24))
                ...
                discharge = plot!()
                #plot!(p, Timeseries[indexfirstday:indexlasttday], Total_Precipitation[indexfirstday:indexlasttday], label="Observed Rainfall",size=(1800,1000), color = ["blue"], linewidth = 3)
                Plots.bar(Timeseries[indexfirstday:indexlasttday], Total_Precipitation[indexfirstday:indexlasttday], label="Measured Precipitation",size=(1800,1000), color = ["blue"], linewidth = 3, framestyle = :box, gridalpha = 0.3,)
                ylabel!("Precipitation [mm/d]")
                xlims!((Dates.value(Timeseries[indexfirstday]), Dates.value(Timeseries[indexlasttday])))
                xticks!([1:1:2;], ["",""])
                precipitation = plot!()
                # plot Temperature
                Plots.plot(Timeseries[indexfirstday:indexlasttday], Temperature_Mean_Elevation[indexfirstday:indexlasttday], label="Measured Temperature",size=(1800,1000), color = ["red"], linewidth = 3, framestyle = :box, gridalpha = 0.3)
                ylabel!("Temperature [°C]")
                xlims!((Dates.value(Timeseries[indexfirstday]), Dates.value(Timeseries[indexlasttday])))
                temperature = plot!()
                if i == 1
                        plot(discharge, precipitation, temperature, layout= (3,1), legend = true, size=(2500,1800), left_margin = [10mm 0mm], bottom_margin = 25px,  top_margin = 25px, xrotation = 0, yguide_fontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300, legendfont=font(18), grid=false, minorgrid=false, yguidefontsize=24)
                else
                        plot(discharge, precipitation, temperature, layout= (3,1), legend = false, size=(2500,1800), left_margin = [10mm 0mm], bottom_margin = 25px, top_margin = 25px, xrotation = 0, yguide_fontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300, legendfont=font(16), grid=false, minorgrid=false, yguidefontsize=24)
                end

                Plots.savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Discharges/Discharge_"*string(current_year)*"_final_report_L2.png")
        end
end
...
function plot_gwstorage(GW_Storage, Timeseries, Catchment_Name, Nr_Years, nr_runs)
        for i in 1:Nr_Years
                ...
                xlabel!("Time in Year")
                savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/GWStorage/GW_Storage_"*string(current_year)*".png")
        end
        ...
        ylabel!("Slow Storage [mm]")
        xlabel!("Time in Year")
        savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/GWStorage/GW_Storage_all_years"*string(current_year)*".png")
        plot()
        for h in 1:nr_runs
                mean_GW = Float64[]
                mean_Date = Date[]
        ...
        ylabel!("Slow Storage [mm]")
        xlabel!("Time in Year")
        savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/GWStorage/GW_Storage_mean_all_years.png")
        #plot!(Timeseries[indexfirstday:indexlasttday], Observed_Discharge[indexfirstday:indexlasttday], label="Observed",size=(1800,1000), color = ["red"])
end
...
function plot_snowstorage(Snowstorage, Timeseries, Catchment_Name, Nr_Years, nr_runs)
        for i in 1:Nr_Years
                ...
                xlabel!("Time in Year")
                savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Snow_Storage/Snow_Storage_"*string(current_year)*".png")
        end
        ...
        ylabel!("Snow Storage [mm]")
        xlabel!("Time in Year")
        savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Snow_Storage/Snow_Storage_all_years"*string(current_year)*".png")
end
...
function plot_snowcover(All_Snow_Cover_Modeled, All_Snow_Cover_Observed, min_elevation, max_elevation, Catchment_Name, Timeseries)
        ...
        for i in 1:1
                ...
                savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Snow_Cover/Snow_Cover_high_elevations2.png")
...
function plot_soilstorage(Soilstorage, Timeseries, Catchment_Name)
        ...
        for h in 1:20
                ...
                savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Soil_Storage/Soilstorage_best_"*string(h)*".png")
        end
end
...
function plot_faststorage(Faststorage, Timeseries, Catchment_Name)
        ...
        for h in 1:20
                ...
                title!("Best parameter set: "*Catchment_Name)
                savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Fast_Storage/Faststorage_best_"*string(h)*".png")
        end
end
...
function plot_snow_elevation(All_Snow_Elevations, Timeseries, min_elevation, max_elevation, Catchment_Name)
        ...
        #ylims!((0,1000))
        savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Calibration/"*Catchment_Name*"/Snow_Storage_Elevation/201_300_bestruns.png")
end

plot_hydrographs_final_report(All_Discharges, Total_Precipitation, Temperature_Mean_Elevation, Timeseries, Catchment_Name, 1, Area_Catchment_Defreggental, 2)
...
function timeseries_discharge()
        Plots.plot()
        modelled =  plot!(Timeseries, All_Discharges[:,1], mode="lines", line_color="gray")
        observed =  plot!(Timeseries, All_Discharges[:,1], mode="lines", line_color="red")
        # plot(modelled, observed)
        total=plot!()
        display(total)
        return
end
...
#                 indexlasttday = findall(x -> x == Dates.lastdayofyear(Date(current_year,1,1)), Timeseries)[1]
#                 #append!(mean_Date, [Timeseries[indexfirstday+182]])
#                 append!(mean_discharge, mean(All_Discharges[indexfirstday:indexlasttday, h]))
#         end
#         if mean_discharge[end] > 100
#                 append!(runs_too_high, h)
#         end
# end
# Plots.plot(mean_discharge, color="red")
#
...
# #xlims!((0,1))
# ylims!((0,1))
# savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/Pitztal/"*Catchment_Name*"_budykoframework_past_real_Data_mean.png")
