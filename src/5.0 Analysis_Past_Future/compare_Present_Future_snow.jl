...
function snow_cover_days_projections(path_to_projections, Catchment_Name, Elevations_Catchment, nr_runs)
    ...
    for i in 13:14
        ...
        # open("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/Mean_Nr_Days_Snow_Past_"*rcp*".csv", "a") do io
        #         writedlm(io, Mean_Nr_Days_Snow_Past,",")
        # end
        open("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/Mean_Nr_Days_Snow_Future_"*rcp*".csv", "a") do io
...
# Mean_Nr_Days_Snow_Past_45 = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/Mean_Nr_Days_Snow_Past_45.csv", ',')
# Mean_Nr_Days_Snow_Future_45 = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/Mean_Nr_Days_Snow_Future_45.csv", ',')
# Mean_Nr_Days_Snow_Past_85 = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/Mean_Nr_Days_Snow_Past_85.csv", ',')
# Mean_Nr_Days_Snow_Future_85 = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/Mean_Nr_Days_Snow_Future_85.csv", ',')
...
function plot_snow_cover(Mean_Nr_Days_Snow_Past_45, Mean_Nr_Days_Snow_Future_45, Mean_Nr_Days_Snow_Past_85, Mean_Nr_Days_Snow_Future_85, Catchment_Name, Elevations_Catchment)
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/"*Catchment_Name*"_rel_change.png")
    plot()
    for (i, elevation) in enumerate(Elevations_Catchment)
    ...
    xticks!([1.5:2:length(Elevations_Catchment)*2-0.5;], string.(Elevations_Catchment))
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/"*Catchment_Name*"_abs_change.png")
    # plot true data
    plot()
    for (i, elevation) in enumerate(Elevations_Catchment)
    ...
    xticks!([1.5:2:length(Elevations_Catchment)*2-0.5;], string.(Elevations_Catchment))
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/"*Catchment_Name*"_comparison_past_futureRCP45.png")
    ...
    xticks!([1.5:2:length(Elevations_Catchment)*2-0.5;], string.(Elevations_Catchment))
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/"*Catchment_Name*"_comparison_past_futureRCP85.png")
    ...
    title!("Relative Change in Annual Number of Snow Days per Elevation in "*Catchment_Name)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/"*Catchment_Name*"_rel_change_2.png")
end
...
function plot_snow_storage_contribution(Snow_Storage_Past45, Snow_Storage_Future45, Snow_Storage_Past85, Snow_Storage_Future85, Catchment_Name)
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/"*Catchment_Name*"_change_snow_melt_new.png")
    ...
    absolute_change = boxplot!()
    plot(relative_change, absolute_change, size=(2000,800), left_margin = [5mm 0mm])
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/"*Catchment_Name*"_snow_melt_past_future_new.png")
end
