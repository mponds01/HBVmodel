...
"""
function analyse_low_flows(path_to_projections, Catchment_Name,  season, nr_runs)
    ...
    for (i, name) in enumerate(Name_Projections)
        ...
        println(name, " ", size(Past_Discharge)[1])
        ...
        # end
        # Past_Discharge = Past_Discharge[1:nr_runs,:]
        # Future_Discharge = Future_Discharge[1:nr_runs,:]
...
function analyse_low_flows_prob_distr(path_to_projections, Catchment_Name, nr_runs)
    Name_Projections = readdir(path_to_projections)
    Timeseries_Past = collect(Date(1981,1,1):Day(1):Date(2010,12,31))
    Timeseries_End = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/End_Timeseries_45_85.txt",',')
...
function plot_low_flows_summer(Seasonal_Low_Flows_past45, Seasonal_Low_Flows_future45, Seasonal_Low_Flows_past85, Seasonal_Low_Flows_future85, Timing_Seasonal_Low_Flows_past45, Timing_Seasonal_Low_Flows_future45,  Timing_Seasonal_Low_Flows_past85, Timing_Seasonal_Low_Flows_future85, Catchment_Name, Area_Catchment, nr_runs)
    ...
    for proj in 1:14
        ...
        savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_summerlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    ...
    #ylims!((2,10))
    title!("Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_summerlowflows.png")
    ...
    #ylims!((2,10))
    title!("Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_summerlowflows_mm.png")
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_timing_summerlowflows.png")
    ...
    for proj in 1:14
        ...
        ylims!((121,289))
        title!("Timing of Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
        savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_timing_summerlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_summerlowflows.png")
    ...
    relative_change = boxplot!()
    plot(absolute_change, relative_change)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_summerlowflows_mm.png")
    ...
    plot(absolute_change, relative_change)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_summerlowflows_violins.png")
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_timing_magnitude_summerlowflows_violins.png")
    ...
    absolute_change_timing = boxplot!()
    plot(relative_change, absolute_change_timing)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_timing_magnitude_summerlowflows.png")
end
...
function plot_low_flows_winter(Seasonal_Low_Flows_past45, Seasonal_Low_Flows_future45, Seasonal_Low_Flows_past85, Seasonal_Low_Flows_future85, Timing_Seasonal_Low_Flows_past45, Timing_Seasonal_Low_Flows_future45,  Timing_Seasonal_Low_Flows_past85, Timing_Seasonal_Low_Flows_future85, Catchment_Name, Area_Catchment, nr_runs)
    ...
    for proj in 1:14
        ...
        savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_winterlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    # plot seasonal low flows of all projections combined
    boxplot(Seasonal_Low_Flows_past45, color=[Farben45[1]])
    boxplot!(Seasonal_Low_Flows_future45,color=[Farben45[2]])
    ...
    #ylims!((2,10))
    title!("Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_winterlowflows.png")
    ...
    #ylims!((2,10))
    title!("Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_winterlowflows_mm.png")
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_timing_winterlowflows.png")
    ...
    for proj in 1:14
        ...
        ylims!((1,335))
        title!("Timing of Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
        savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_timing_winterlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    ...
    relative_change = boxplot!()
    plot(absolute_change, relative_change)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_winterlowflows.png")
    #absolute and relative decrease in mm
    boxplot(convertDischarge(Seasonal_Low_Flows_future45, Area_Catchment) - convertDischarge(Seasonal_Low_Flows_past45, Area_Catchment),color=[Farben45[2]])
    #boxplot!(, color=[Farben85[1]])
    boxplot!(convertDischarge(Seasonal_Low_Flows_future85, Area_Catchment) - convertDischarge(Seasonal_Low_Flows_past85, Area_Catchment), size=(1000,500), leg=false, left_margin = [5mm 0mm], xrotation = 60, color=[Farben85[2]], bottom_margin = 20px)
    ...
    relative_change = boxplot!()
    plot(absolute_change, relative_change)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_winterlowflows_mm.png")
    ...
    plot(absolute_change, relative_change)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_winterlowflows_violins.png")
    ...
    absolute_change_timing = boxplot!()
    plot(relative_change, absolute_change_timing)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_timing_magnitude_winterlowflows_violins.png")
    ...
    absolute_change_timing = boxplot!()
    plot(relative_change, absolute_change_timing)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_timing_magnitude_winterlowflows.png")
end
...
function monthly_days_Q90(path_to_projections, Area_Catchment, Catchment_Name)
    ...
    for (i, name) in enumerate(Name_Projections)
        Timeseries_Future = collect(Date(Timeseries_End[i,index]-29,1,1):Day(1):Date(Timeseries_End[i,index],12,31))
        Past_Discharge = readdlm(path_projected*"Past/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/NS_model_results_discharge_Past.csv", ',')
...
function monthly_days_Q90_PforF(path_to_projections, Area_Catchment, Catchment_Name)
    #Threshold_old = convertDischarge(Threshold, Area_Catchment)
    Name_Projections = readdir(path_to_projections)
    Timeseries_Past = collect(Date(1981,1,1):Day(1):Date(2010,12,31))
    ...
    for (i, name) in enumerate(Name_Projections)
        Timeseries_Future = collect(Date(Timeseries_End[i,index]-29,1,1):Day(1):Date(Timeseries_End[i,index],12,31))
        Past_Discharge = readdlm("/Volumes/Magali 2/Data_Projected/Past/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Past.csv", ',')
        Future_Discharge = readdlm("/Volumes/Magali 2//Data_Projected/Future/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Future.csv", ',')
        Past_Discharge_m3 = Past_Discharge
        Past_Discharge = convertDischarge(Past_Discharge, Area_Catchment)
        Future_Discharge = convertDischarge(Future_Discharge, Area_Catchment)
        # get threshold based on past discharge
        #print(size(Past_Discharge))
        allruns=min(size(Past_Discharge)[1], size(Future_Discharge)[1])
        for run in 1:allruns
            FDC = flowdurationcurve(Past_Discharge_m3[run,:])
            Threshold = convertDischarge(FDC[1][findnearest(FDC[2], 0.90)], Area_Catchment)
            #println("Threshold real: ", Threshold_old, "Threshold modelled: ", Threshold)
            Current_Dates_Low_Flows_Past = Timeseries_Past[findall(x->x < Threshold, Past_Discharge[run,:])]
...
function monthly_days_Q90_NS(path_to_projections, Area_Catchment, Catchment_Name)
    #Threshold_old = convertDischarge(Threshold, Area_Catchment)
    Name_Projections = readdir(path_to_projections)
    Timeseries_Past = collect(Date(1981,1,1):Day(1):Date(2010,12,31))
    Timeseries_End = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/End_Timeseries_45_85.txt",',')
    ...
    for (i, name) in enumerate(Name_Projections)
        ...
        if Catchment_Name=="Silbertal"
            Past_Discharge = readdlm("/Volumes/Magali 2/Data_projected/Future/NS/Silbertal/Silbertal_mac/Past/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Past.csv", ',')
            Future_Discharge = readdlm("/Volumes/Magali 2/Data_projected/Future/NS/Silbertal/Silbertal_mac/Future/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Future.csv", ',')
        else
            Past_Discharge = readdlm("/Volumes/Magali 2/Data_Projected/Past/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Past.csv", ',')
            Future_Discharge = readdlm("/Volumes/Magali 2//Data_Projected/Future/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Future.csv", ',')
        end
...
function plot_monthly_low_flows(Nr_Days_Drought_monthly_past_45, Nr_Days_Drought_monthly_future_45, Nr_Days_Drought_monthly_past_85, Nr_Days_Drought_monthly_future_85, Catchment_Name, nr_runs)
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_monthly_low_flows_45_modelled_threshold_Q95.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_monthly_low_flows_85_modelled_threshold_Q95.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_abs_change_monthly_low_flows_modelled_threshold_Q95.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_abs_change_monthly_low_flows_violin_modelled_threshold_Q95.png")
    ...
    # xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    # #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    # savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_relative_change_monthly_low_flows.png")
end
...
function plot_monthly_deficit(Deficit_monthly_past_45, Deficit_monthly_future_45, Deficit_monthly_past_85, Deficit_monthly_future_85, Catchment_Name, nr_runs)
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_monthly_deficit_45_modelled_threshold_Q95.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_monthly_deficit_85_modelled_threshold_Q95.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_abs_change_deficit_modelled_threshold_Q95.png")
    ...
    xticks!([1.5:2:23.5;], ["Jan", "Feb", "Mar", "Apr", "May","Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
    #xticks!([2:2:24;], ["Jan 8.5", "Feb 8.5", "Mar 8.5", "Apr 8.5", "May 8.5","Jun 8.5", "Jul 8.5", "Aug 8.5", "Sep 8.5", "Oct 8.5", "Nov 8.5", "Dec 8.5"])
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*Catchment_Name*"_abs_change_deficit_violin_modelled_threshold_Q95.png")
end
...
function Q90_precipitation(path_to_projections, Area_Catchment, Catchment_Name)
    ...
    for (i, name) in enumerate(Name_Projections)
        Timeseries_Future = collect(Date(Timeseries_End[i,index]-29,1,1):Day(1):Date(Timeseries_End[i,index],12,31))
        Past_Discharge = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/Past/S/"*Catchment_Name*"/"*rcp*"/"*name*"/S_model_results_discharge_Past.csv", ',')
        Future_Discharge = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/Future/S/"*Catchment_Name*"/"*rcp*"/"*name*"/S_model_results_discharge_Future.csv", ',')
        Past_Precipitation = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/Past/S/"*Catchment_Name*"/"*rcp*"/"*name*"/S_results_precipitation_Past.csv", ',')
        Future_Precipitation = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/Future/S/"*Catchment_Name*"/"*rcp*"/"*name*"/S_results_precipitation_Future.csv", ',')
        Past_Discharge_m3 = Past_Discharge
        Future_Discharge_m3 = Future_Discharge
        nr_runs = min(size(Past_Discharge)[1], size(Future_Discharge)[1])
        Past_Discharge = convertDischarge(Past_Discharge[1:nr_runs], Area_Catchment)
        Future_Discharge = convertDischarge(Future_Discharge[1:nr_runs], Area_Catchment)
        # get threshold based on past discharge
        #print(size(Past_Discharge))
...
function Q90_precipitation_NS(path_to_projections, Area_Catchment, Catchment_Name)
    Name_Projections = readdir(path_to_projections)
    Timeseries_Past = collect(Date(1981,1,1):Day(1):Date(2010,12,31))
    Timeseries_End = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/End_Timeseries_45_85.txt",',')
    if path_to_projections[end-2:end-1] == "45"
    ...
    for (i, name) in enumerate(Name_Projections)
        ...
        # Past_Discharge = readdlm("/Users/magali/Documents/Thesis/Data_Projected/Past/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Past.csv", ',')
        # Future_Discharge = readdlm("/Users/magali/Documents/Thesis/Data_Projected/Future/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Future.csv", ',')
        Past_Precipitation = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/Past/S/"*Catchment_Name*"/"*rcp*"/"*name*"/S_results_precipitation_Past.csv", ',')
        Future_Precipitation = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/Future/S/"*Catchment_Name*"/"*rcp*"/"*name*"/S_results_precipitation_Future.csv", ',')
        Past_Discharge_m3 = Past_Discharge
        Future_Discharge_m3 = Future_Discharge
...
function Q90_precipitation_PforF(path_to_projections, Area_Catchment, Catchment_Name)
    Name_Projections = readdir(path_to_projections)
    Timeseries_Past = collect(Date(1981,1,1):Day(1):Date(2010,12,31))
    Timeseries_End = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data/Projections/End_Timeseries_45_85.txt",',')
    if path_to_projections[end-2:end-1] == "45"
    ...
    for (i, name) in enumerate(Name_Projections)
        Timeseries_Future = collect(Date(Timeseries_End[i,index]-29,1,1):Day(1):Date(Timeseries_End[i,index],12,31))
        # Past_Discharge = readdlm("/Users/magali/Documents/Thesis/Data_Projected/Past/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Past.csv", ',')
        # if Catchment_Name == "Palten" || Catchment_Name=="Pitztal" || Catchment_Name=="Silbertal"
        #     Future_Discharge = readdlm("/Users/magali/Documents/Thesis/Data_Projected/Future/PforF/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_WB_PforF_streamflow_projection_Future.csv", ',')
        # else
        #     Future_Discharge = readdlm("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Data_Projected/Future/PforF/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_WB_PforF_streamflow_projection_Future.csv", ',')
        # end
        Past_Discharge = readdlm("/Volumes/Magali 2/Data_Projected/Past/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_NS_streamflow_projection_Past.csv", ',')
        Future_Discharge = readdlm("/Volumes/Magali 2//Data_Projected/Future/NS/"*Catchment_Name*"/"*rcp*"/"*name*"/combined_WB_PforF_streamflow_projection_Future.csv", ',')
...
#     ylabel!("Days")
#     savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_length_Threshold"*string(Threshold)*"_"*season*".png")
...
#     ylabel!("Nr. of Events")
#     savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_nr_events_Threshold"*string(Threshold)*"_"*season*".png")
...
#     ylabel!("Days")
#     savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_max_length_Threshold"*string(Threshold)*"_"*season*".png")
#     # make violin plots
...
#     title!("Change in Mean Yearly Number of Drought Days "*season*", Threshold= " *string(Threshold))
#     ylabel!("Days")
#     savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_length_Threshold"*string(Threshold)*"_violin_"*season*".png")
#     #plot change in number of drought events per year
...
#     title!("Change in Mean Yearly Number of Drought Events "*season*", Threshold= " *string(Threshold))
#     ylabel!("Nr. of Events")
#     savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_nr_events_Threshold"*string(Threshold)*"_violin_"*season*".png")
#     # plot cahnge in maximum  drought length per year
...
#     title!("Change in Mean Maximum Yearly Drought Length "*season*", Threshold= " *string(Threshold))
#     ylabel!("Days")
#     savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_max_length_Threshold"*string(Threshold)*"_violin_"*season*".png")
# end
...
function plot_drought_extremes_statistics(Drought_45, Drought_85, Catchment_Name)
    ...
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_length_Threshold"*string(Threshold)*"_all_years_"*season*".png")
    #plot change in number of drought events per year
    ...
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_nr_events_Threshold"*string(Threshold)*"_all_years_"*season*".png")
    # plot cahnge in maximum  drought length per year
    ...
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_max_length_Threshold"*string(Threshold)*"_all_years_"*season*".png")
    ...
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_mean_length_Threshold"*string(Threshold)*"_all_years_"*season*".png")
    ...
    ylabel!("[mm]]")
    Max_Deficit = boxplot!()
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_max_deficit"*string(Threshold)*"_all_years_"*season*".png")
    ...
    # #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_max_Intensity"*string(Threshold)*"_all_years_"*season*".png")
    ...
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_mean_deficit"*string(Threshold)*"_all_years_"*season*".png")
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/drought_extremes_comparison_all_years.png")
    # make violin plots
    # plot change in Number of Drought days in year
    plot()
    ...
    plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, layout= (2,3), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/drought_extremes_comparison_all_years_violin.png")
end
...
function plot_drought_extremes_statistics_change(Drought_45, Drought_85, Catchment_Name)
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/drought_extremes_comparison_all_years_absolute_change.png")
    # make violin plots
    # plot change in Number of Drought days in year
    plot()
    ...
    Max_Deficit = violin!()
    plot(Nr_Drought_Days, Nr_Drought_Events, Mean_Drought_Length, Max_Deficit, layout= (2,2), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/drought_extremes_comparison_all_years_absolute_change_violin.png")
end
...
function plot_drought_statistics(Drought_45, Drought_85, Threshold, Catchment_Name, Area_Catchment, season)
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics_comparison"*string(Threshold)*"_all_years_"*season*".png")
    # make violin plots
    # plot change in Number of Drought days in year
    ...
    ylabel!("Intensity [mm/d]")
    Mean_Intensity = boxplot!()
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_mean_deficit"*string(Threshold)*"_violin_all_years_"*season*".png")
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics_comparison"*string(Threshold)*"_all_years_"*season*"_violin.png")
end
...
function plot_drought_statistics_rel_change(Drought_45, Drought_85, Threshold, Catchment_Name, Area_Catchment, season)
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_rel_change_4metrics.png")
    # plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, Max_Intensity, Mean_Intensity, layout= (2,4), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    # savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/drought_statistics"*string(Threshold)*"_all_years_"*season*"_rel_change.png")
    # make violin plots
    ...
    hline!([0], color=["grey"], linestyle = :dash)
    Nr_Drought_Days = violin!()
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_length_Threshold"*string(Threshold)*"_violin_all_years_"*season*".png")
    #plot change in number of drought events per year
    ...
    hline!([0], color=["grey"], linestyle = :dash)
    Nr_Drought_Events = violin!()
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_nr_events_Threshold"*string(Threshold)*"_violin_all_years_"*season*".png")
    # plot cahnge in maximum  drought length per year
    ...
    hline!([0], color=["grey"], linestyle = :dash)
    Max_Drought_Length = violin!()
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_max_length_Threshold"*string(Threshold)*"_violin_all_years_"*season*".png")
    ...
    hline!([0], color=["grey"], linestyle = :dash)
    Mean_Drought_Length = violin!()
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_mean_length_Threshold"*string(Threshold)*"_violin_all_years_"*season*".png")
    ...
    hline!([0], color=["grey"], linestyle = :dash)
    Max_Deficit = violin!()
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_max_deficit"*string(Threshold)*"_violin_all_years_"*season*".png")
    # plot change mean deficit
    ...
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_max_Intensity"*string(Threshold)*"_violin_all_years_"*season*".png")
    # plot change mean Intensity
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_rel_change_violin_4metrics_font.png")
    plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, Max_Intensity, Mean_Intensity, layout= (2,4), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_rel_change_violin.png")
end
...
function plot_drought_statistics_change(Drought_45, Drought_85, Threshold, Catchment_Name, Area_Catchment, season)
    ...
    #savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/change_mean_deficit"*string(Threshold)*"_all_years_"*season*".png")
    plot(Nr_Drought_Days, Mean_Drought_Length, Mean_Deficit, Mean_Intensity, layout= (2,2), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_4metrics.png")
    # plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, Max_Intensity, Mean_Intensity, layout= (2,4), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    # savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/drought_statistics"*string(Threshold)*"_all_years_"*season*".png")
    # make violin plots
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_violin_4metrics_font.png")
    plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, Max_Intensity, Mean_Intensity, layout= (2,4), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_violin.png")
end
...
function plot_drought_total_deficit(Drought_45, Drought_85, Threshold, Catchment_Name, Area_Catchment, season)
    ...
    savefig("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics_total_deficit"*string(Threshold)*"_all_years_"*season*".png")
end

# Discharge_Feistritz = CSV.read("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/HBVModel/Feistritz/Q-Tagesmittel-214353.csv", header= false, skipto=388, decimal=',', delim = ';', types=[String, Float64])
# Discharge_Palten = CSV.read("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/HBVModel/Palten/Q-Tagesmittel-210815.csv", header= false, skipto=21, decimal=',', delim = ';', types=[String, Float64])
# #Area_Zones = [98227533.0, 184294158.0, 83478138.0, 220613195.0]
# #Area_Catchment_Gailtal = sum(Area_Zones)
# #Discharge_Gailtal = CSV.read("/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/HBVModel/Gailtal/Q-Tagesmittel-212670.csv", header= false, skipto=23, decimal=',', delim = ';', types=[String, Float64])
