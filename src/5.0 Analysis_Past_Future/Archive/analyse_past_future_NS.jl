...
# using PyPlot
# using Dates
path_macpro="/Volumes/Macintosh HD - Gegevens 1/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/"

path_45 = path_macpro*"/Data/Projections/climate_simulations/rcp45/"
Name_Projections_45 = readdir(path_45)
path_85 = path_macpro*"/Data/Projections/climate_simulations/rcp85/"
...
Discharge_Feistritz = CSV.read(path_macpro*"/HBVModel/Feistritz/Q-Tagesmittel-214353.csv", DataFrame, header= false, skipto=388, decimal=',', delim = ';', types=[String, Float64])
Discharge_Palten = CSV.read(path_macpro*"/HBVModel/Palten/Q-Tagesmittel-210815.csv", DataFrame, header= false, skipto=21, decimal=',', delim = ';', types=[String, Float64])
Discharge_Gailtal = CSV.read(path_macpro*"/HBVModel/Gailtal/Q-Tagesmittel-212670.csv", DataFrame, header= false, skipto=23, decimal=',', delim = ';', types=[String, Float64])
Discharge_Silbertal = CSV.read(path_macpro*"/HBVModel/Silbertal/Q-Tagesmittel-200048.csv", DataFrame, header= false, skipto=24, decimal=',', delim = ';', types=[String, Float64])
Discharge_Defreggental = CSV.read(path_macpro*"/HBVModel/Defreggental/Q-Tagesmittel-212100.csv",DataFrame,  header= false, skipto=26, decimal=',', delim = ';', types=[String, Float64])
Discharge_Pitztal = CSV.read(path_macpro*"/HBVModel/Pitztal/Q-Tagesmittel-201335.csv", DataFrame, header= false, skipto=23, decimal=',', delim = ';', types=[String, Float64])
...
# writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/discharge_months_8.5.txt",hcat(months_85, monthly_Discharge_past_85, monthly_Discharge_future_85, Monthly_Discharge_Change_85),',')
# end
# #
# @time begin
...
# writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/discharge_months_4.5.txt",hcat(months_45, monthly_Discharge_past_45, monthly_Discharge_future_45, Monthly_Discharge_Change_45),',')
# end
# #
# monthly_changes_85 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/discharge_months_8.5.txt", ',')
...
# monthly_changes_45 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/discharge_months_4.5.txt", ',')
...
# savefig(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/"*Catchment_Name*"_measured_monthly_discharge_mm.png")
#
# # ---------------- ANNUAL DISCHARGE --------------------
#
...
# All_Catchments = ["Defreggental", "Feistritz", "Gailtal", "Palten", "Pitztal", "Silbertal"]
...
#     writedlm(path_macpro*"Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Discharge/annual_discharge_45.csv", hcat(    relative_change_45, Total_Discharge_Past_45, Total_Discharge_Future_45) ',')
#     writedlm(path_macpro*"Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Discharge/annual_discharge_85.csv", hcat(    relative_change_85, Total_Discharge_Past_85, Total_Discharge_Future_85) ',')
#     end
# end
...
#     writedlm(path_macpro*"Results/Projections/"*Catchment_Name*"/PastvsFuture/FDC/discharge_45.csv", hcat(discharge_past_45, discharge_future_45), ',')
#     writedlm(path_macpro*"Results/Projections/"*Catchment_Name*"/PastvsFuture/FDC/discharge_85.csv", hcat(discharge_past_85, discharge_future_85), ',')
# end
## or directly plotted
...
#     writedlm(path_macpro*"Results/Projections/"*Catchment_Name*"/PastvsFuture/Budyko/Budyko_45.csv", hcat(aridity_past45, aridity_future_45, evaporative_past_45, evaporative_future_45, prec_past45, prec_future_45) ',')
#     writedlm(path_macpro*"Results/Projections/"*Catchment_Name*"/PastvsFuture/Budyko/Budyko_85.csv", hcat(    aridity_past85, aridity_future_85, evaporative_past_85, evaporative_future_85,  prec_past85, prec_future_85) ',')
#
# end
...
#         writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Budyko/monthly_runoff_coefficient_4.5_new.txt",hcat(monthly_runoff_coef_past, monthly_runoff_coef_future, months),',')
#         writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/monthly_discharge_all_years_past_4.5.txt", monthly_discharge_past)
#         writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/monthly_discharge_all_years_future_4.5.txt", monthly_discharge_future)
#     end
#     @time begin
#         monthly_runoff_coef_past, monthly_runoff_coef_future, months, monthly_discharge_past, monthly_discharge_future = monthly_runoff_coefficient(path_85, Catchment_Name, Area_Catchments[c], nr_runs[c])
#         writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Budyko/monthly_runoff_coefficient_8.5_new.txt",hcat(monthly_runoff_coef_past, monthly_runoff_coef_future, months),',')
#         writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/monthly_discharge_all_years_past_8.5.txt", monthly_discharge_past)
#         writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Monthly_Discharge/monthly_discharge_all_years_future_8.5.txt", monthly_discharge_future)
#     end
#     @time begin
#     seasonal_runoff_coef_past, seasonal_runoff_coef_future, all_seasons = seasonal_runoff_coefficient(path_45, Catchment_Name, nr_runs[c])
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Budyko/seasonal_runoff_coefficient_4.5.txt",hcat(seasonal_runoff_coef_past, seasonal_runoff_coef_future, all_seasons),',')
#     end
#
#     @time begin
#     seasonal_runoff_coef_past_85, seasonal_runoff_coef_future_85, all_seasons_85 = seasonal_runoff_coefficient(path_85, Catchment_Name, nr_runs[c])
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Budyko/seasonal_runoff_coefficient_8.5.txt",hcat(seasonal_runoff_coef_past_85, seasonal_runoff_coef_future_85, all_seasons_85 ),',')
#     end
# end
#     #
#
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Max_Discharge/change_max_Annual_Discharge_4.5.txt",hcat(average_max_Discharge_past_45, average_max_Discharge_future_45, Timing_max_Discharge_past_45, Timing_max_Discharge_future_45, All_Concentration_past_45, All_Concentration_future_45),',')
#     end
#
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Max_Discharge/change_max_Annual_Discharge_8.5.txt",hcat(average_max_Discharge_past_85, average_max_Discharge_future_85, Timing_max_Discharge_past_85, Timing_max_Discharge_future_85, All_Concentration_past_85, All_Concentration_future_85),',')
#     end
# end
# #
# # annual_max_flow_45 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Max_Discharge/change_max_Annual_Discharge_4.5.txt",',')
# # annual_max_flow_85 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Max_Discharge/change_max_Annual_Discharge_8.5.txt",',')
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Max_Discharge/change_max_Annual_Discharge_prob_distr_4.5.txt",hcat(max_Discharge_Past_45, Max_Discharge_Future_45, Exceedance_Probability_45, Date_Past_45, Date_Future_45), ',')
#     end
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Max_Discharge/change_max_Annual_Discharge_prob_distr_8.5.txt",hcat(max_Discharge_Past_85, Max_Discharge_Future_85, Exceedance_Probability_85, Date_Past_85, Date_Future_85), ',')
#     end
# end
# # max_discharge_prob_45 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Max_Discharge/change_max_Annual_Discharge_prob_distr_4.5.txt", ',')
...
# #
# # max_discharge_prob_85 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Annual_Max_Discharge/change_max_Annual_Discharge_prob_distr_8.5.txt", ',')
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_summer4.5.txt",hcat(Summer_Low_Flows_past45, Summer_Low_Flows_future45, Timing_Summer_Low_Flows_Past_45, Timing_Summer_Low_Flows_Future_45, concentration_past_45, concentration_future_45),',')
#     end
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_summer8.5.txt",hcat(Summer_Low_Flows_past85, Summer_Low_Flows_future85, Timing_Summer_Low_Flows_Past_85, Timing_Summer_Low_Flows_Future_85, concentration_past_85, concentration_future_85),',')
#     end
# end
# #
# # low_flows_summer_85 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_summer8.5.txt", ',')
...
# # low_flows_summer_45 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_summer4.5.txt", ',')
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_winter4.5.txt",hcat(Winter_Low_Flows_past45, Winter_Low_Flows_future45, Timing_Winter_Low_Flows_Past_45, Timing_Winter_Low_Flows_Future_45, concentration_past_45, concentration_future_45),',')
#     end
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_winter8.5.txt",hcat(Winter_Low_Flows_past85, Winter_Low_Flows_future85, Timing_Winter_Low_Flows_Past_85, Timing_Winter_Low_Flows_Future_85, concentration_past_85, concentration_future_85),',')
#     end
# end
# # low_flows_winter_85 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_winter8.5.txt", ',')
...
# # low_flows_winter_45 = readdlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_winter4.5.txt", ',')
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_whole_year4.5.txt",hcat(Summer_Low_Flows_past45, Summer_Low_Flows_future45, Timing_Summer_Low_Flows_Past_45, Timing_Summer_Low_Flows_Future_45, concentration_past_45, concentration_future_45),',')
#     end
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_whole_year8.5.txt",hcat(Summer_Low_Flows_past85, Summer_Low_Flows_future85, Timing_Summer_Low_Flows_Past_85, Timing_Summer_Low_Flows_Future_85, concentration_past_85, concentration_future_85),',')
#     end
#
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_prob_distr_4.5.txt",hcat(max_Discharge_Past_45, Max_Discharge_Future_45, Exceedance_Probability_45, Date_Past_45, Date_Future_45), ',')
#     end
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/LowFlows/low_flows_prob_distr_8.5.txt",hcat(max_Discharge_Past_85, Max_Discharge_Future_85, Exceedance_Probability_85, Date_Past_85, Date_Future_85), ',')
#     end
# end
#
...
#
#     @time begin
#     Drought_45 = compare_hydrological_drought(path_45, threshold, season, Area_Catchments[c], Catchment_Name, "yearly")
#     end
#     @time begin
#     Drought_85 = compare_hydrological_drought(path_85, threshold, season, Area_Catchments[c], Catchment_Name, "yearly")
#     end
#
...
#
#     @time begin
#         Nr_Days_Drought_monthly_past_45, Nr_Days_Drought_monthly_future_45, Deficit_monthly_past_45, Deficit_monthly_future_45, Threshold_45 = monthly_days_Q90(path_45, Area_Catchments[c], Catchment_Name)
#         Nr_Days_Drought_monthly_past_85, Nr_Days_Drought_monthly_future_85, Deficit_monthly_past_85, Deficit_monthly_future_85, Threshold_85 = monthly_days_Q90(path_85, Area_Catchments[c], Catchment_Name)
#         writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/monthly_days_deficit_Q90_4.5.txt",hcat(Nr_Days_Drought_monthly_past_45, Nr_Days_Drought_monthly_future_45, Deficit_monthly_past_45, Deficit_monthly_future_45, Threshold_45),',')
#         writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Drought/monthly_days_deficit_Q90_8.5.txt",hcat(Nr_Days_Drought_monthly_past_85, Nr_Days_Drought_monthly_future_85, Deficit_monthly_past_85, Deficit_monthly_future_85, Threshold_85),',')
#     end
# end
...
# #
# nr_runs = []
# Catchment_Areas = [Area_Catchment_Defreggental, Area_Catchment_Feistritz, Area_Catchment_Gailtal, Area_Catchment_Palten, Area_Catchment_Pitztal, Area_Catchment_Silbertal]
# All_Catchments = ["Defreggental", "Feistritz", "Gailtal", "Palten", "Pitztal", "Silbertal"]
# for (c, Catchment_Name) in enumerate(All_Catchments)
#
#     # @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/snow_melt_months_8.5.txt",hcat(months_85, monthly_Discharge_past_85, monthly_Discharge_future_85, Monthly_Discharge_Change_85),',')
#     end
#     #
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/snow_melt_months_4.5.txt",hcat(months_45, monthly_Discharge_past_45, monthly_Discharge_future_45, Monthly_Discharge_Change_45),',')
#     end
#
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/snow_storage_months_8.5.txt",hcat(months_85, monthly_Discharge_past_85, monthly_Discharge_future_85, Monthly_Discharge_Change_85),',')
#     end
#     #
#     @time begin
...
#     writedlm(path_macpro*"/Results/Projections/"*Catchment_Name*"/PastvsFuture/Snow_Cover/snow_storage_months_4.5.txt",hcat(months_45, monthly_Discharge_past_45, monthly_Discharge_future_45, Monthly_Discharge_Change_45),',')
#     end
# end
