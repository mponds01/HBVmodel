...
function NS_parameterset_defreggental(path_to_best_calibrations, rcp, rcm)
    ...
    Timeframes = ["OP", "MF"]
    parameter_range = CSV.read("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Srdef_ranges/"*rcp*"/"*rcm*"/Defreggental_srdef_range.csv", DataFrame, decimal = '.', delim = ',' )
...
function NS_parameterset_feistritz(path_to_best_calibrations, rcp, rcm)
    ...
    Timeframes = ["OP", "MF"]
    parameter_range = CSV.read("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Srdef_ranges/"*rcp*"/"*rcm*"/Feistritz_srdef_range.csv", DataFrame, decimal = '.', delim = ',' )
...
function NS_parameterset_gailtal(path_to_best_calibrations, rcp, rcm)
    ...
    Timeframes = ["OP", "MF"]
    parameter_range = CSV.read("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Srdef_ranges/"*rcp*"/"*rcm*"/Gailtal_srdef_range.csv", DataFrame, decimal = '.', delim = ',' )
    ##println(parameter_range)
...
function NS_parameterset_paltental(path_to_best_calibrations, rcp, rcm)
    ...
    Timeframes = ["OP", "MF"]
    parameter_range = CSV.read("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Srdef_ranges/"*rcp*"/"*rcm*"/Palten_srdef_range.csv", DataFrame, decimal = '.', delim = ',' )
    #println(parameter_range)
...
function NS_parameterset_pitztal(path_to_best_calibrations, rcp, rcm)
    ...
    Timeframes = ["OP", "MF"]
    parameter_range = CSV.read("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Srdef_ranges/"*rcp*"/"*rcm*"/Pitztal_srdef_range.csv", DataFrame, decimal = '.', delim = ',' )
    #println(parameter_range)
...
function NS_parameterset_silbertal(path_to_best_calibrations, rcp, rcm)
    ...
    Timeframes = ["OP", "MF"]
    parameter_range = CSV.read("/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Results/Rootzone/Srdef_ranges/"*rcp*"/"*rcm*"/Silbertal_srdef_range.csv", DataFrame, decimal = '.', delim = ',' )
    #println(parameter_range)
