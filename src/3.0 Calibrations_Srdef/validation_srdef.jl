...
function run_validation_gailtal_srdef(path_to_best_parameter, startyear, endyear)
        ...
        parameters_best_calibrations = best_calibrations[1:3000,:]#[:,10:29]
...
function run_validation_pitztal_srdef(path_to_best_parameter, startyear, endyear)
        ...
        GWStorage = 60.0
        best_calibrations = readdlm(path_to_best_parameter, ',')
        parameters_best_calibrations = best_calibrations[1:3000,:]#[:,10:30]
        println(size(parameters_best_calibrations))
...
function run_All_Goodness()
        catchment = ["Pitztal", "Silbertal"] # "Defreggental",  "Feistritz", "Gailtal", "Palten",
                ...
                #rcms = readdir(local_path*rcp)
                        ...
                        for (j,rcm) in enumerate(rcms)
                                ...
                                println("hii:", cm, rcp, rcm)
                                        ...
                                        path_to_calibration = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations_Srdef/"*cm*"/Samples/"*rcp*"/NS_Parameterset_OP_"*rcp*"_"*rcm*".csv"
                                        ...
                                        validation_title = "NS_Parameterfit_srdef_validated.csv"
                                        save_validation = "/Users/magali/Documents/1. Master/1.4 Thesis/02 Execution/01 Model Sarah/Calibrations_Srdef/"*cm*"/Validation/"*rcp*"/"*rcm*"/"*validation_title
